 ...
 */
final class Version20221118091648 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season_id INT DEFAULT NULL, DROP season_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE episode ADD season_id_id INT NOT NULL, DROP season_id');
